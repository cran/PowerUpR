...
mrss.bira3r1 <- function(mdes=.25, power=.80, alpha=.05, two.tail=TRUE,
...
# mrss.bira3r1(rho3=.20, rho2=.15, omega3=.10, omega2=.10, n=12, K=14)
# mrss.bira3r1(rho3=.20, rho2=.15, omega3=.10, omega2=.10, J=3, K=14)
...
optimal.bira3r1 <- function(cn, cJ, cK, cost=NULL, n=NULL, J=NULL, K=NULL,
