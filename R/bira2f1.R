...
mrss.bira2f1 <- function(mdes=.25, power=.80, alpha=.05, two.tail=TRUE,
...
optimal.bira2f1 <- function(cn, cJ, cost=NULL, n=NULL, J=NULL,
...
# optimal.bira2f1(cn=1, cJ=10, cost=560, constrain="cost")

# optimal sample given per unit costs and power 
# optimal.bira2f1(cn=1, cJ=10, constrain="power", gm=300)

# optimal sample given per unit costs and mdes
# optimal.bira2f1(cn=1, cJ=10, constrain="mdes", gm=30)

# conditional optimal sample (fixed n=10) given total cost
# optimal.bira2f1(cn=1, cJ=10, n=10, cost=560, constrain="cost")

# conditional optimal sample (fixed n=10) given per unit costs and power 
# optimal.bira2f1(cn=1, cJ=10, n=10, constrain="power")

# conditional optimal sample (fixed n=10) given per unit costs and mdes
# optimal.bira2f1(cn=1, cJ=10, n=10, constrain="mdes")
