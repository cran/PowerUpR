...
cosa.bcra4r3 <- function(cn=0, cJ=0, cK=0, cL=0, cost=NULL,
...
# cosa.bcra4r3(cn=1, cJ=10, cK=100, cL=1000, cost=75600, constrain="cost",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50)

# cosa given per unit costs and power
# cosa.bcra4r3(cn=1, cJ=10, cK=100, cL=1000, power=.80, constrain="power",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50)

# cosa given per unit costs and mdes
# cosa.bcra4r3(cn=1, cJ=10, cK=100, cL=1000, power=.80, constrain="mdes",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50)

# cosa (fixed n=10, and J=2) given total cost
# cosa.bcra4r3(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, cost=75600, constrain="cost",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50)

# cosa (fixed n=10, and J=2) given per unit costs and power
# cosa.bcra4r3(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, power=.80, constrain="power",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50)

# cosa (fixed n=10, and J=2) given per unit costs and mdes
# cosa.bcra4r3(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, power=.80, constrain="mdes",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50)
