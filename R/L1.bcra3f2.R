...
cosa.bcra3f2 <- function(cn=0, cJ=0, cK=0, cost=NULL,
...
# cosa.bcra3f2(cn=1, cJ=10, cK=100, cost=5600, constrain="cost", rho2=.20)

# cosa given per unit costs and power
# cosa.bcra3f2(cn=1, cJ=10, cK=100, power=.80, constrain="power", rho2=.20)

# cosa given per unit costs and mdes
# cosa.bcra3f2(cn=1, cJ=10, cK=100, power=.80, constrain="mdes",  rho2=.20)

# cosa (fixed n=10) given total cost
# cosa.bcra3f2(cn=1, cJ=10, cK=100, n=10, cost=5600, constrain="cost",  rho2=.20)

# cosa (fixed J=10) given per unit costs and power
# cosa.bcra3f2(cn=1, cJ=10, cK=100, J=10, constrain="power", rho2=.20)

# cosa (fixed n=10) given per unit costs and mdes
# cosa.bcra3f2(cn=1, cJ=10, cK=100, K=3, constrain="mdes", rho2=.20)
