...
mrss.bcra3r2 <- function(mdes=.25, power=.80, alpha=.05, two.tail=TRUE,
...
# mrss.bcra3r2(rho3=.13, rho2=.10, omega3=.4, n=10, K=23)
# mrss.bcra3r2(rho3=.13, rho2=.10, omega3=.4, J=6, K=23)
...
optimal.bcra3r2 <- function(cn, cJ, cK, cost=NULL, n=NULL, J=NULL, K=NULL,
